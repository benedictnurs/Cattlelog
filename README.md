# Cattlelog
Ever wanted to see how software gets scaled to 40K+ users? From frontend, backend, DB, data engineering, and infrastructure? Worry no more! I founded Cattlelog with a few friends in college, and I'm sharing this repo to be used, referenced, and forked! I encourage every student to try to replicate this sort of project for their community, whether in Davis or at any school!
